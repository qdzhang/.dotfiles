...
package_archives_args=(
    ...
    --eval "(add-to-list 'package-archives '(\"gnu\" . \"https://mirrors.bfsu.edu.cn/elpa/gnu/\") t)"
    --eval "(add-to-list 'package-archives '(\"melpa\" . \"https://mirrors.bfsu.edu.cn/elpa/melpa/\") t)"
    --eval "(add-to-list 'package-archives '(\"nongnu\" . \"https://mirrors.bfsu.edu.cn/elpa/nongnu/\") t)"
)

org_package_archives_args=(
    --eval "(add-to-list 'package-archives '(\"org\" . \"https://mirrors.bfsu.edu.cn/elpa/org/\") t)"
)
